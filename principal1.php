<? 
   ...
   $produtos = array(
    array("Img/roupa1.jpg", "Blusa 1"),
    array("Img/roupa1.jpg", "Blusa 2"),
    array("Img/roupa1.jpg", "Blusa 3"),
    array("Img/roupa1.jpg", "Blusa 4"),
    array("Img/roupa1.jpg", "Blusa 5"),
    array("Img/roupa1.jpg", "Blusa 6"),
   );
...
<html>
  <head>
    ...
    <script
      src="https://kit.fontawesome.com/54f9cce8ca.js"
        ...
        <div class="container">
          <div class="navbar-header">
            <a href="#" class="navbar-brand" id="logo">
              <img src="Imagens/logo-site0000.png" alt=""
            /></a>
          </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input
                          ...
                          class="form-control"
                          id="inputNome"
                          placeholder="Digite o tipo do tecido do Produto"
                        />
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input
                          ...
                          class="form-control"
                          id="inputNome"
                          placeholder="Digite a estampa do Produto"
                        />
                      </div>
                    </div>
